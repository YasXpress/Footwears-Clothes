      ...
      if(localStorage.getItem("ADMIN")==="true" && UI.length != 0 && UI[0].userName !=""){
          ...
          if(sessionStorage.getItem("ADMIN_U_I") != 0){
              sessionStorage.setItem("ADMIN_U_I",sessionStorage.getItem("ADMIN_U_I")-1)
                ...
                let red_D = UI[sessionStorage.getItem("ADMIN_U_I")].view === 'F' ?`<span class="red_D"></span>`:'';
              ...
              data-d="${UI[sessionStorage.getItem("ADMIN_U_I")].view}";>
                  <p class="A_MCD_MAIN_FI">${red_D}</p>
              ...
              A_MCD_MAIN_FC.forEach((e)=>{
                  e.addEventListener('click',()=>{
                      ...
                      let dataDashed_userD=e.dataset.d;
                      ...
                      if(dataDashed_userD === 'F'){
                        // Update order in the database
                        update(ref(db, `UI/${dataDashed_userPhoneNumber}`), {
                            userName:dataDashed_userName,
                            phoneNumber:dataDashed_userPhoneNumber,
                            order:dataDashed_userOrder,
                            view:"T"
                        });
        ...
        //delete user
        document.querySelector('.A_MCD_D').addEventListener('click',()=>{
